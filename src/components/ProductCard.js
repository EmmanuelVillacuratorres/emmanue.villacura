...
const ProductCard = ({ 
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col h-full bg-white rounded-xl shadow-md p-6 ${
    ...
    >
      ...
      <div className="flex flex-col flex-grow">
        ...
        <p className="text-gray-600 mb-4 leading-relaxed flex-grow">{product.Descripcion}</p>
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="ml-auto font-bold text-xl">{formatPrice(product.Precio)}</span>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        {!isAdmin ? ( 
          <motion.button
            ...
            disabled={!disponible}
            className={`mt-auto w-full py-2 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2 ${
              disponible
          ...
          <>
            <motion.button
              ...
              className="mt-auto w-full py-2 rounded-lg font-semibold bg-blue-500 text-white hover:bg-blue-600 transition-all duration-300"
            ...
            <button
              ...
              className={`mt-auto w-full py-2 rounded-lg font-semibold transition-all duration-300 ${
                product.Disponible
